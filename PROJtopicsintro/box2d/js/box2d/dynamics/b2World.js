// DFSKLAR CHANGES EXIST HERE:
// Now the Step function returns true if world was awake and something changed, false if all objects at rest (asleep).
...
b2World.prototype = 
{
	...
	// size. The number of shapes found is returend.
