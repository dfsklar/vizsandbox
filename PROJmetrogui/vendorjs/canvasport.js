var canvasport = {
    ...
    getDrawing: function(canvas)
    {
	 ...
	 // default fillstyle is red, but to override, just pass in a
	 // string like:  "rgba(255,...,..., 1)"
    _fillText: function(ctx, text, posx, posy, font, fillstyle)
    {
        if(ctx.fillText)
            {
                ...
                if(ctx.mozDrawText)
                    {
                        ctx.save();
								console.log("WE ARE USING MOZDRAWTEXT (deprecated)");
