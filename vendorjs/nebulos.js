...
metaaps.nebulos = function(container) {
    ...
    this.screenportion = 0.3;
	 ...
	 // THIS DOES WORK: sets the color for the text being painted
	 // Give each component a value between 0 and 255 inclus
    this.fillstyle = {red: 255, green: 0, blue: 0};
...
metaaps.nebulos.prototype = {
    ...
    draw: function(data, options)
    {
        ...
        var errormessage = "Could not place: ";
		  ...
		  // This function draws exactly one word/phrase:
        function draw(){
            ...
            if(nebulos.textlistcount < textlist.length)
                {
                    setTimeout(draw, 500);//this.drawdelay);
                } else {
                    nebulos.running = false;
                }
        }
        setTimeout(draw, this.drawdelay);
    },
